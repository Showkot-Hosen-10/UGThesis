...
PromptLight, a four-layer cascade  input normaliser, regex screen, netuned ALBERT classier, and phrase-level SHAP audit  built for live
...
rmed signicant at McNemar χ
2 = 5.45, p = 0.020. Head-to-head against
ProtectAI DeBERTa-v3, ne-tuned ALBERT is statistically indistinguishable in decision quality at 16× fewer parameters, while the full cascade significantly outperforms it. We also characterise an ambiguous-vocabulary falsepositive problem and propose a dual-AUC reporting convention  raw production AUC alongside clean-subset AUC  as a methodological safeguard.
